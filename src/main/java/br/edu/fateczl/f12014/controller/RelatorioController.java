package br.edu.fateczl.f12014.controller;
...
import br.edu.fateczl.f12014.persistence.GenericDao;
...
public class RelatorioController {
	...
	public ResponseEntity geraRelatorio(@RequestParam Map<String, String> params) {
		...
		try {
			...
			File arquivo = ResourceUtils.getFile("classpath:reports/F12014LabBD20222.jasper");
			JasperReport report = 
